...
INSERT INTO tb_permissao_acesso (codigo, descricao, tp_usuario) VALUES ('ROLE_FIL_ACESSO_PERFIL', 'Filial / Acesso / Perfil', 'ACFP');
INSERT INTO tb_permissao_acesso (codigo, descricao, tp_usuario) VALUES ('ROLE_FIL_ACESSO_USUARIO', 'Filial / Acesso / Usuário', 'ACFP');
...
INSERT INTO tb_permissao_acesso (codigo, descricao, tp_usuario) VALUES ('ROLE_PRO_ACESSO_PERFIL', 'Proprietário / Acesso / Perfil', 'A');
INSERT INTO tb_permissao_acesso (codigo, descricao, tp_usuario) VALUES ('ROLE_PRO_ACESSO_USUARIO', 'Proprietário / Acesso / Usuário', 'A');

INSERT INTO tb_permissao_acesso (codigo, descricao, tp_usuario) VALUES ('ROLE_PRODUTOS', 'Produtos', 'ACFRP');
...
INSERT INTO tb_permissao_acesso (codigo, descricao, tp_usuario) VALUES ('ROLE_COMPRA', 'Compra', 'CFP');
INSERT INTO tb_permissao_acesso (codigo, descricao, tp_usuario) VALUES ('ROLE_COMPRA_VISUALIZACAO_ESTOQUE', 'Compra - Visualização Estoque', 'ACFRP');

INSERT INTO tb_permissao_acesso (codigo, descricao, tp_usuario) VALUES ('ROLE_PEDIDO_CONSULTA', 'Pedido / Consulta', 'ACFRP');
...
INSERT INTO tb_permissao_acesso (codigo, descricao, tp_usuario) VALUES ('ROLE_PEDIDO_BOLETOS', 'Pedido / Boletos', 'A');

INSERT INTO tb_permissao_acesso (codigo, descricao, tp_usuario) VALUES ('ROLE_COTACAO_CONSULTA', 'Cotação / Consulta', 'A');
INSERT INTO tb_permissao_acesso (codigo, descricao, tp_usuario) VALUES ('ROLE_COTACAO_CADASTRO', 'Cotação / Consulta - Cadastro', 'A');
INSERT INTO tb_permissao_acesso (codigo, descricao, tp_usuario) VALUES ('ROLE_COTACAO_FINALIZACAO', 'Cotação / Consulta - Finalização', 'A');
...
INSERT INTO tb_permissao_acesso (codigo, descricao, tp_usuario) VALUES ('ROLE_TROCA_SOLICITACAO', 'Troca / Solicitação', 'CFP');
INSERT INTO tb_permissao_acesso (codigo, descricao, tp_usuario) VALUES ('ROLE_TROCA_CONSULTA', 'Troca / Consulta', 'ACFP');
INSERT INTO tb_permissao_acesso (codigo, descricao, tp_usuario) VALUES ('ROLE_TROCA_FINALIZACAO', 'Troca / Consulta - Finalização', 'A');
INSERT INTO tb_permissao_acesso (codigo, descricao, tp_usuario) VALUES ('ROLE_TROCA_CANCELAMENTO', 'Troca / Consulta - Cancelamento', 'A');
