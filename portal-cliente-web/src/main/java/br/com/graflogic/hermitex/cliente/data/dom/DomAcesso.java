...
public class DomAcesso {
	...
	public static class DomPermissaoAcesso extends DomBase {
		...
		public static final String ROLE_COTACAO_CONSULTA = "ROLE_COTACAO_CONSULTA";
		public static final String ROLE_COTACAO_CADASTRO = "ROLE_COTACAO_CADASTRO";
		public static final String ROLE_COTACAO_FINALIZACAO = "ROLE_COTACAO_FINALIZACAO";
		public static final String ROLE_COTACAO_CANCELAMENTO = "ROLE_COTACAO_CANCELAMENTO";
		public static final String ROLE_COTACAO_DESCONTO_LIVRE = "ROLE_COTACAO_DESCONTO_LIVRE";
		public static final String ROLE_COTACAO_DESCONTO_ESPECIAL = "ROLE_COTACAO_DESCONTO_ESPECIAL";
		public static final String ROLE_COTACAO_DESCONTO_GERENCIAL = "ROLE_COTACAO_DESCONTO_GERENCIAL";
